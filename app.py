...
FLAG = os.getenv("FLAG", "Ohno bug happen,, can you tell the challenge creator?")
...
def get_bot_response():
    ...
    if len(words) > 5 and "secret" in words:
        response = f"Whoa... you're so clever! But are you really ready for the flag? Well, here it is... {FLAG}"
...
if __name__ == "__main__":
    app.run(debug=True, host='0.0.0.0', port=5487)
